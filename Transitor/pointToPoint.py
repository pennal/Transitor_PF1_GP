...
def returnHTMLTable(data):
    ...
    for i in range(0,len(data["connections"])):
        ...
        try:
            ...
            print("Transfers len: ",len(newData))
            # for transfer in range(1,len(newData)):
            ...
            #     TEMPLATE_FILE = basePath + "/JinjaTemplates/transfersTemplate.jinja"
            #     # Read the template file using the environment object.
            #     # This also constructs our Template object.
            #     template = templateEnv.get_template( TEMPLATE_FILE )
            #
            #     # Specify any input variables to the template as a dictionary.
            #     templateVars = { "intermediateStep" : intermediateStation,
            #                      "arrivalTimeStep" : arrivalTimeStep,
